...
#define QUARTER_ARRAY_SIZE (ARRAY_SIZE / 4)

#define BEGIN_CORE0_ARRAY       (0)
#define END_CORE0_ARRAY       (QUARTER_ARRAY_SIZE)

#define BEGIN_CORE1_ARRAY     (END_CORE0_ARRAY)
#define END_CORE1_ARRAY       (BEGIN_CORE1_ARRAY + QUARTER_ARRAY_SIZE)

#define BEGIN_CORE2_ARRAY       (END_CORE1_ARRAY)
#define END_CORE2_ARRAY       (BEGIN_CORE2_ARRAY + QUARTER_ARRAY_SIZE)

#define BEGIN_CORE3_ARRAY       (END_CORE2_ARRAY)
#define END_CORE3_ARRAY       (BEGIN_CORE3_ARRAY + QUARTER_ARRAY_SIZE)
